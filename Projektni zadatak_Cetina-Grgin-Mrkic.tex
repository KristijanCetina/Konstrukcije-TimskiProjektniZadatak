...
Konstrukcijski sklop izrađen je unutar ograničenja zadanih projektnim zadatkom.
Izrađeni su proračuni dimenzija zopčanika i vratila, proračun momenata i sila na zupčanicima, preliminarni i kontrolni proračun vratila, proračun steznog spoja te valjnih ležajeva.
Na kraju se nalaze radionički nacrti kao i sklopni crtež sklopa.

Elementi proračuna koji su izostavljeni navedeni su u opis zadatka i oganičenja u poglavlju \ref{OpisIOgranicenja}
...
\hspace{50pt}\=\kill
 ...
 Mentori: \> Milenko Jokić, dipl. ing. stroj. \\ 
  \> Feđa Balić, mag. ing. mech.
\end{tabbing} 
...
$$
Prema \cite{krivzan1998osnove} (str. 77, tablica 3.23) za navedeni stezni spoj odabrana su tolerancijska polja \textbf{H7/r6}.
...
\addcontentsline{toc}{chapter}{Dodatak C: Radionički nacrt gonjenog zupčanika}
\includepdf[fitpaper]{OutputDrawings/GonjeniZupcanikLight.pdf}
\addcontentsline{toc}{chapter}{Dodatak D: Radionički nacrt distantnog prstena}
\includepdf[fitpaper]{OutputDrawings/DistantniPrsten.pdf}
\addcontentsline{toc}{chapter}{Dodatak E: Sklopni nacrt reduktora}
\includepdf[fitpaper]{OutputDrawings/SklopniNacrtReduktora.pdf}
\end{document}